...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.showsGridMajor) {
        ...
        UIRectFill(CGRectMake(roundf(width -1), borderPadding, 1.0f, roundf(height) - borderPadding * 2));
        UIRectFill(CGRectMake(borderPadding, roundf(height -1), roundf(width) - borderPadding * 2, 1.0f));
    }
}
...
{
    CGRect f = [self cropRectMakeWithResizeControlView:resizeControlView];
